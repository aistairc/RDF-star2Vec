...
import jp.go.aist.airc.dkirt.rdfstar2vec.RDF2Vec;
import jp.go.aist.airc.dkirt.rdfstar2vec.RDF2VecLight;
...
import jp.go.aist.airc.dkirt.rdfstar2vec.util.VectorTxtToTfProjectorTsv;
import jp.go.aist.airc.dkirt.rdfstar2vec.walk_generation.base.WalkGenerationMode;
import jp.go.aist.airc.dkirt.rdfstar2vec.walk_generation.walk_generators.HdtWalkGenerator;
...
import static jp.go.aist.airc.dkirt.rdfstar2vec.util.Util.*;
...
class MainTest {
    ...
    public void walkGenerationForStar() {
        ...
        walkDirectory.mkdir();
        walkDirectory.deleteOnExit();
        System.out.println(kg.getAbsolutePath());

        /* 
         * Mid-walk walk generation for RDF-star.
         * This walk employs Quoted Triple (QT) walk that allows for walking from a QT to an entity comprised in the QT and vice versa.
         */
         ...
         * This walk was implemented for employing the original RDF2vec when input data is RDF-star.
         * Expand the contents of the QT and consider it like a normal triple.
         */
//        String[] mainArgs = new String[]{
//        		"-graph", kg.getAbsolutePath(), 
//        		"-onlyWalks",
...
//        try {
//            FileUtils.deleteDirectory(new File("./classicWalks2/"));
//        } catch (IOException ioe) {
