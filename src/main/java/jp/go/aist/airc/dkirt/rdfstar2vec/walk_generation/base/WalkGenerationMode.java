package jp.go.aist.airc.dkirt.rdfstar2vec.walk_generation.base;
...
public enum WalkGenerationMode {
	/**
     * Plain RDF-star random walks generated in a forward-fashion (going backwards is not allowed).
     */
    STAR_RANDOM_WALKS,
	...
	/**
     * Mid-walk walk generation for RDF-star: Given an entity, it is randomly decided whether to go backwards or forwards during
    ...
    public static WalkGenerationMode getModeFromString(String modeString) {
        ...
        switch (modeString) {
        	case "star_random_walks":
        		return STAR_RANDOM_WALKS;
        	case "star_random_walks_duplicate_free":
        		return STAR_RANDOM_WALKS_DUPLICATE_FREE;
        	case "star_mid_walks":
        		return STAR_MID_WALKS;
        	case "star_mid_walks_duplicate_free":
        		return STAR_MID_WALKS_DUPLICATE_FREE;
            case "mid_walks":
                return MID_WALKS;
