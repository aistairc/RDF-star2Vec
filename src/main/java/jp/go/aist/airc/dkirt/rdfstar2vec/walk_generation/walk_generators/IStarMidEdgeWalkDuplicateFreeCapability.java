...
public interface IStarMidEdgeWalkDuplicateFreeCapability extends IWalkGenerationCapability {
     ...
     */
    List<String> generateMidEdgeWalksForEntityDuplicateFree(String entity, int numberOfWalks, int depth, double probabilityFromQtToSubject, double probabilityFromObjectToQt);
}
