...
import static jp.go.aist.airc.dkirt.rdfstar2vec.util.Util.getDimensionalityFromVectorTextFile;
import static jp.go.aist.airc.dkirt.rdfstar2vec.util.Util.getNumberOfNonBlancLines;
