 ...
 */
public class QuotedTripleDataSetMemory {


    /**
     * Constructor
     */
    public QuotedTripleDataSetMemory() {
    ...
    /*
     * Map key: "<<subject-predicate-object>>"
     * Map value: QuotedTriple
     */
    Map<String, QuotedTriple> quotedTriples;

    private static final Logger LOGGER = LoggerFactory.getLogger(QuotedTripleDataSetMemory.class);
     ...
     * @param object    Object
     */
    public void addObjectQuotedTriple(String qt, String subject, String predicate, String object) {
        addObjectQuotedTriple(new QuotedTriple(qt, subject, predicate, object));
    }
    
    public void addDatatypeQuotedTriple(String qt, String subject, String predicate, String stringObject) {
        addDatatypeQuotedTriple(new QuotedTriple(qt, subject, predicate, stringObject));
    }
     ...
     *
     * @param tripleToAdd QuotedTriple where the object is a string.
     */
    public synchronized void addDatatypeQuotedTriple(QuotedTriple tripleToAdd) {
        this.objectNodes.add(tripleToAdd.subject);
        this.quotedTriples.put(tripleToAdd.qt, tripleToAdd);
     ...
     *
     * @param tripleToAdd QuotedTriple to be added.
     */
    public synchronized void addObjectQuotedTriple(QuotedTriple tripleToAdd) {
        if (this.quotedTriples.containsKey(tripleToAdd.qt)) {
            return;
        }
//        this.objectNodes.add(tripleToAdd.subject);
//        this.objectNodes.add(tripleToAdd.object);
//        this.objectNodes.add(tripleToAdd.qt);
        this.quotedTriples.put(tripleToAdd.qt, tripleToAdd);
...
//        objectTriples.add(tripleToAdd);
     ...
     */
    public synchronized void addAllObjectTriples(QuotedTripleDataSetMemory dataToAdd) {
    ...
    /**
     * Returns unique object triple and datatype triple subjects! If you only need object triple subjects use {@link QuotedTripleDataSetMemory#getUniqueObjectTripleSubjects()}.
     *
     ...
     * {@link QuotedTripleDataSetMemory#objectTriples}.
     *
    ...
    public Map<String, QuotedTriple> getQuotedTriples() {
     ...
     */
    public static QuotedTripleDataSetMemory parseNtFile(File ntFile) {
        return parseNtFile(ntFile, StandardCharsets.UTF_8);
    }

    public static QuotedTripleDataSetMemory parseNtFile(File ntFile, Charset charset) {
        QuotedTripleDataSetMemory result = new QuotedTripleDataSetMemory();
